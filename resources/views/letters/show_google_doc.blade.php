            ...
            <div class="p-6">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">This feature is currently unavailable.</p>
                    </div>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-yellow-700">
                                The letter feature has been temporarily disabled. Please contact the administrator for more information.
                            </p>
                        </div>
                    </div>
                </div>
