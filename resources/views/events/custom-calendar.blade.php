                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6 sticky top-8">
                    ...
                    <div class="mb-4">
                        <div class="flex space-x-2">
                            <div class="flex-1">
                                <input type="text" placeholder="Search Events..." class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#c21313] transition duration-200">
                            </div>
                            <button type="button" class="bg-[#c21313] text-white px-4 py-2 rounded-md text-sm hover:bg-[#a51010] transition duration-200">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function createEventCard(event) {
            ...
            card.className = 'event-card flex flex-col md:flex-row cursor-pointer';
            ...
            card.innerHTML = `
                <div class="md:w-1/4 event-image">
                    <img src="${randomImage}" alt="${event.title}">
                </div>
